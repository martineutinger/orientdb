 ...
 */
public class OSQLFunctionIDAstarTest {
    ...
    private Vertex               v5;
    private Vertex               v6;
    private OSQLFunctionIDAstar functionIDAstar;
    ...
    public void setUp() throws Exception {
        ...
        functionIDAstar = new OSQLFunctionIDAstar();
    }
    ...
    private void setUpDatabase() {
        dbCounter++;
        graph = new OrientGraph("memory:OSQLFunctionIDAstarTest" + dbCounter);
    ...
    public void test1Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_DIRECTION, "out");
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v1, v4,"'weight'",options },
    ...
    public void test2Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v1, v6,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
    ...
    public void test3Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v1, v6,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(3, result.size());
    ...
    public void test4Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon","alt"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v1, v6,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(3, result.size());
    ...
    public void test5Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v3, v5,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(3, result.size());
    ...
    public void test6Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v6, v1,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
    ...
    public void test7Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        options.put(OSQLFunctionIDAstar.PARAM_HEURISTIC_FORMULA, "EucliDEAN");
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v6, v1,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(6, result.size());
    ...
    public void test8Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_TIE_BREAKER, false);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        options.put(OSQLFunctionIDAstar.PARAM_HEURISTIC_FORMULA, HeuristicFormula.EUCLIDEANNOSQR);
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v6, v1,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
    ...
    public void test9Execute() throws Exception {
        Map<String, Object> options = new HashMap<String, Object>();
        options.put(OSQLFunctionIDAstar.PARAM_DIRECTION, Direction.BOTH);
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_TIE_BREAKER, false);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        options.put(OSQLFunctionIDAstar.PARAM_HEURISTIC_FORMULA, HeuristicFormula.MAXAXIS);
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v6, v1,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(3, result.size());
    ...
    public void test10Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        options.put(OSQLFunctionIDAstar.PARAM_HEURISTIC_FORMULA, HeuristicFormula.CUSTOM);
        options.put(OSQLFunctionIDAstar.PARAM_CUSTOM_HEURISTIC_FORMULA, "myCustomHeuristic");
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v6, v1,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(6, result.size());
    ...
    public void test11Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_TIE_BREAKER, false);
        options.put(OSQLFunctionIDAstar.PARAM_EMPTY_IF_MAX_DEPTH, true);
        options.put(OSQLFunctionIDAstar.PARAM_MAX_DEPTH, 3);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        options.put(OSQLFunctionIDAstar.PARAM_HEURISTIC_FORMULA, HeuristicFormula.CUSTOM);
        options.put(OSQLFunctionIDAstar.PARAM_CUSTOM_HEURISTIC_FORMULA, "myCustomHeuristic");
    ...
    public void test12Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_TIE_BREAKER, false);
        options.put(OSQLFunctionIDAstar.PARAM_EMPTY_IF_MAX_DEPTH, false);
        options.put(OSQLFunctionIDAstar.PARAM_MAX_DEPTH, 3);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        options.put(OSQLFunctionIDAstar.PARAM_VERTEX_AXIS_NAMES, new String[]{"lat","lon"});
        options.put(OSQLFunctionIDAstar.PARAM_HEURISTIC_FORMULA, HeuristicFormula.CUSTOM);
    ...
    public void test13Execute() throws Exception {
        ...
        options.put(OSQLFunctionIDAstar.PARAM_PARALLEL, true);
        options.put(OSQLFunctionIDAstar.PARAM_EDGE_TYPE_NAMES, new String[]{"has_path"});
        final List<OrientVertex> result = functionIDAstar.execute(null, null, null, new Object[] { v1, v0,"'weight'",options },
                new OBasicCommandContext());
        assertEquals(16, graph.countEdges("has_path"));
        assertEquals(0, result.size());
    }
